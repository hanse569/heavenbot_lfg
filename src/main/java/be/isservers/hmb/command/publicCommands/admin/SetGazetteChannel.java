...
public class SetGazetteChannel implements ICommand {
    @Override
    public void handle(CommandContext ctx) {
        ...
        channel.sendMessageFormat("New channel for Gazette has been set to `%s`",ctx.getChannel().getName()).queue();
    }
